            ...
            {({open}) => (
                <>
                    <div className=' space-y-2'>
                        ...
                        <div className='relative cursor-pointer hover:placeholder-opacity-70 transition p-10
                    ...
                    type='hidden'
                    name='image'
                    defaultValue={imageUrl ? imageUrl : image}></input>
                </>
            )}
        </CldUploadWidget>
    )
